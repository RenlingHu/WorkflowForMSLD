...
class Converter:
    ...
    def add_atom_to_zmatrix(self, i, line, atoms=None):
        ...
        if (atoms == None):
            atoms = [0, 1, 2]
        atom1, atom2, atom3 = [self.cartesian[x] for x in atoms]
        ...
        coords = [[atoms[0], distance], [atoms[1], np.degrees(angle)], [
            atoms[2], np.degrees(dihedral)]]
